...
body {height:100%;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:small;background:#f6f6f6;}
...
input,select,textarea,label {font:inherit;}
...
.header {
	...
	.wrapper .nav li.rightnav { float:right; margin:0 0 0 0;}
	...
	.wrapper #pill {list-style:none;position:absolute;top:0px;right:0;}
...
#sidebar .section p.small {margin:15px 0 0 0;}
#sidebar .section input.text {width:175px;padding:4px;border:1px solid #666;}
...
.edit-nav select {margin-top:-3px;float:right;padding:1px;border:1px solid #999;border-radius: 2px;
	-moz-border-radius: 2px;
	-webkit-border-radius: 2px;}
.edit-nav p {float:right;margin:0;}
.edit-nav label {font-weight:100;display:inline;color:#666;margin:0;padding:0;}
...
.wrapper table th {background:#FFF !important;padding:2px 4px;border-top:1px solid #FFF;color:#222;font-weight:bold;text-transform:uppercase;line-height:20px !important;text-align:left;}
.wrapper table tr.head {}
.wrapper table td span {color:#777;}
...
#metadata_window #menu-items span label {display:inline;color:#777;font-weight:normal;margin:0;padding:0;}
...
table.comptable tr td {border: none;padding:0;}
table.comptable tr td code {color:#666;padding:0 4px 0 0;display:block;font-family: Consolas, Monaco, "Courier New", Courier, monospace;}
...
.delete a:link, .delete a:visited {
	...
	display:block;line-height:16px;font-weight:normal;
	-webkit-transition: all .15s ease-in-out;
	-moz-transition: all .15s ease-in-out;
	-o-transition: all .15s ease-in-out;
	transition: all .15s ease-in-out;
	}
.delete a:hover {background:#D94136 !important; color:#fff !important; text-decoration:none !important;padding: 1px;line-height:16px;display:block;font-weight:normal; }
...
.wrapper .secondarylink {width:20px;text-align:center;line-height:14px;}
...
/* backup info display */
table.simple td {border:1px solid #eee;border-collapse:collapse;color:#555;padding:4px 10px 4px 4px;}
...
#handw {z-index:1;padding:8px;background:#000;opacity:.80;color:#fff;width:150px;text-align:center;margin:-50px 0 0 0;}
...
.qc_pager .qp_counter {margin:0 10px 0 0;}
...
#index p.cta,
#resetpassword p.cta {margin:0 0 0 0;color:#999;}
#index p.cta a,
...
.desc {line-height:17px;border-bottom:1px dotted #ccc;padding:0 0 15px 0;margin:0 0 5px 0;}

#filter-search  {margin:0 0 10px 0;display:none;}
#filter-search input.text {width:250px;padding:3px;}

#createfolder {font-weight:100;text-decoration:underline !important;}
h5 .crumbs, div.h5 .crumbs {float:left;}
#new-folder {float:left;padding-left:5px;}
#new-folder form {display:none;}
#new-folder .cancel {text-shadow:none !important;}
#new-folder input.submit {padding:3px;}
#new-folder input.text {width:120px;padding:3px;}
